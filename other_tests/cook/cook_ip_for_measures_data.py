...
def run_ip(year, res):
    ...
    nc_file = xr.open_dataset(f"/uolstore/Research/b/b0133/eartsu/new_model_misc/cook_study/annual_ip_data_new/{res}m_res/{year}.nc")
    ...
    outdir = f"/uolstore/Research/b/b0133/eartsu/new_model_misc/cook_study/annual_ip_out_new/{reg_phigrad}_{reg_cgrad}_{reg_phi}_{reg_c}_lambda{lambda_}_{ip_iterations}its/{res}m_res/"
...
def run_ip_measures(res):
    ...
    print("Extracting things from ncdf")
    nc_file = xr.open_dataset(f"/uolstore/Research/b/b0133/eartsu/new_model_misc/cook_study/annual_ip_data_new/{res}m_res/measures.nc")
    ...
    outdir = f"/uolstore/Research/b/b0133/eartsu/new_model_misc/cook_study/annual_ip_out_new/{reg_phigrad}_{reg_cgrad}_{reg_phi}_{reg_c}_lambda{lambda_}_{ip_iterations}its_INITIAL_MEASURES/{res}m_res/"
    os.system(f"mkdir -p {outdir}")
...
def run_ip_measures_prior(year, res):
    ...
    measures_ctrl_dir = "/uolstore/Research/b/b0133/eartsu/new_model_misc/cook_study/annual_ip_out_new/1000000.0_0.2_1.0_1e-06_lambda0.002_40its_INITIAL_MEASURES/500m_res/"
    ...
    outdir = f"/uolstore/Research/b/b0133/eartsu/new_model_misc/cook_study/annual_ip_out_new/{reg_phigrad}_{reg_cgrad}_{reg_phi}_{reg_c}_lambda{lambda_}_{ip_iterations}its_measuresCprior/{res}m_res/"
    os.system(f"mkdir -p {outdir}")
