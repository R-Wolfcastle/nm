...
def compute_linear_ssa_residuals_function_fc_visc_new_noextrap_dt(ny, nx, dy, dx, b,
                                          interp_cc_to_fc,
                                          fc_vel_gradient,
                                          add_uv_ghost_cells,
                                          add_s_ghost_cells,
...
def compute_ssa_uv_residuals_function_pnotC_givenT_noextrap_dt(ny, nx, dy, dx, b,
                                   beta_fct,
                                   interp_cc_to_fc,
                                   fc_vel_gradient,
                                   add_uv_ghost_cells,
