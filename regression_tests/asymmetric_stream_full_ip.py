...
def wonky_stream_jagged_front():
    ...
    thk = thk.at[:,-2:].set(0)
    thk = thk.at[::2,-3].set(0)
    thk = thk.at[70:90, -10:].set(0)
...
lbfgsb_iterator = lbfgsb_function(regularised_misfit, (speed_obs, uc), iterations=10)
