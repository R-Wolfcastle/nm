...
misfit_fct = make_misfit_function_speed_basic(uo, uc, 1e2, solver, u_init, v_init)
lbfgs_iterator = lbfgsb_function(misfit_fct, iterations=100)
...
np.save("../../../bits_of_data/ice_shelf_ip/mucoef_inv_100its.npy", mucoef_inv)
