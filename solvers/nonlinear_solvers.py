...
#
#            print("constructing LA problem")
#            #partial_res_fct = lambda x, y: get_uv_residuals_linear_ssa(x, y, h_1d, mu_ew, mu_ns, mu_nc, beta)
#            #residuals, linearised_res_function = jax.linearize(partial_res_fct, u_1d, v_1d)
#            #transposed_linearised_res_function = jax.linear_transpose(linearised_res_function, u_1d, v_1d)
#            #
#            ##residuals, linearised_res_function = jax.linearize(get_uv_residuals_linear_ssa, 
#            ##                                                   u_1d, v_1d, h_1d, mu_ew, mu_ns, mu_nc, beta)
#            ##transposed_linearised_res_function = jax.linear_transpose(linearised_res_function,
#            ##                                                          u_1d, v_1d, h_1d, mu_ew, mu_ns, mu_nc, beta)
#
#            #nz_jac_values = assemble_jacobian(transposed_linearised_res_function)
#
...
#            duv = cg_solver(nz_jac_values, rhs, duv)
#
#            print("du norm: {}".format(jnp.max(jnp.abs(duv))))
#
#            u_1d = (u_1d + omega*duv[:(ny*nx)]) * ice_mask
#            v_1d = (v_1d + omega*duv[(ny*nx):]) * ice_mask
#            
