...
silent only
silent tabonly
cd ~/new_model_code/src/nm/scratch_test/expt/SOA
...
badd +1 synthetic_soa_test.py
badd +1 ../2D_tests/larsen_c.py
argglobal
%argdel
$argadd synthetic_soa_test.py
edit synthetic_soa_test.py
...
silent! normal! zE
let &fdl = &fdl
let s:l = 781 - ((37 * winheight(0) + 29) / 59)
...
silent! normal! zE
let &fdl = &fdl
let s:l = 687 - ((18 * winheight(0) + 9) / 19)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 687
...
wincmd w
argglobal
if bufexists(fnamemodify("synthetic_soa_test.py", ":p")) | buffer synthetic_soa_test.py | else | edit synthetic_soa_test.py | endif
balt ../2D_tests/larsen_c.py
setlocal autoindent
setlocal backupcopy=
setlocal nobinary
setlocal nobreakindent
...
silent! normal! zE
let &fdl = &fdl
let s:l = 786 - ((24 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 786
