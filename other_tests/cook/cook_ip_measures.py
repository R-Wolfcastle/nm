...
def run_ip(res):
    ...
    nc_file = xr.open_dataset(f"/uolstore/Research/b/b0133/eartsu/new_model_misc/cook_study/annual_ip_data/{res}m_res/measures.nc")
    ...
    outdir = f"/uolstore/Research/b/b0133/eartsu/new_model_misc/cook_study/annual_ip_out/{reg_phigrad}_{reg_cgrad}_{reg_phi}_{reg_c}_lambda{lambda_}_{ip_iterations}its/{res}m_res/"
